...
### GoogLeNet Accuracy
<!--ACCURACY_googlenet_PLACEHOLDER-->Accuracy: Top-1: 44.05% | Top-5: 68.80% (updated: 2026-04-03)<!--END_ACCURACY_googlenet-->

### DenseNet Accuracy
<!--ACCURACY_densenet_PLACEHOLDER-->Accuracy: Top-1: 65.79% | Top-5: 86.92% (updated: 2026-04-03)<!--END_ACCURACY_densenet-->
